      ...
      >
        <View className="px-6 py-4">
          ...
          <Section title="5. Seller Responsibilities">
            ...
            returns for valid reasons
          </Section>

          <Section title="6. Return Shipping">
            If a return is approved:{"\n\n"}• Seller error: Seller pays return
          ...
          <Section title="7. Refund Timeline">
            ...
            Refund processed within 3-5 business days after seller receives the

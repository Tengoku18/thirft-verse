    ...
    <View className="flex-1 bg-white">
      ...
      <View className="px-6 pt-16 pb-6 border-b border-[#F3F4F6]">
        <View className="flex-row items-center justify-between">
          ...
          <ThemedText className="text-[24px] font-[PlayfairDisplay_700Bold]" style={{ color: '#3B2F2F' }}>
            Settings
          </ThemedText>
          <View className="w-10" />
        </View>
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="mx-6 mt-6 mb-4 p-4 bg-[#FAFAFA] rounded-2xl">
          <View className="flex-row items-center">
            <View className="w-12 h-12 rounded-full bg-[#3B2F2F] justify-center items-center mr-3">
              <ThemedText className="text-xl font-bold font-[PlayfairDisplay_700Bold]" style={{ color: '#FFFFFF' }}>
                {user?.user_metadata?.name?.charAt(0).toUpperCase() || 'U'}
              </ThemedText>
            </View>
            <View className="flex-1">
              <ThemedText className="text-[16px] font-[NunitoSans_700Bold]" style={{ color: '#3B2F2F' }}>
                {user?.user_metadata?.name || 'User'}
              </ThemedText>
              <ThemedText className="text-[13px] font-[NunitoSans_400Regular]" style={{ color: '#6B7280' }}>
                {user?.email}
              </ThemedText>
            </View>
          </View>
              ...
              {section.options.map((option, index) => (
                ...
                >
                  <View className="w-10 h-10 rounded-full bg-[#FAFAFA] justify-center items-center mr-4">
                    <IconSymbol name={option.icon as any} size={20} color="#3B2F2F" />
                  </View>
                  <View className="flex-1">
                    <ThemedText className="text-[15px] font-[NunitoSans_600SemiBold]" style={{ color: '#3B2F2F' }}>
                      {option.label}
                    </ThemedText>
                  </View>
        ...
        <View className="px-6 mb-8">
          ...
          >
            <View className="flex-row items-center gap-2">
              ...
              <ThemedText className="text-base font-[NunitoSans_700Bold]" style={{ color: '#EF4444' }}>
                Logout
              </ThemedText>
            </View>
          </TouchableOpacity>
        ...
        <View className="items-center pb-8">
          <ThemedText className="text-[12px] font-[NunitoSans_400Regular]" style={{ color: '#9CA3AF' }}>
            ThriftVerse v1.0.0
          </ThemedText>
          <ThemedText className="text-[11px] font-[NunitoSans_400Regular] mt-1" style={{ color: '#D1D5DB' }}>

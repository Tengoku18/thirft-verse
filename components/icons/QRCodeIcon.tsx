...
interface QRCodeIconProps extends SvgProps {
  size?: number;
}

const QRCodeIcon: React.FC<QRCodeIconProps> = ({ size, ...props }) => (
  <Svg
    viewBox="0 0 24 24"

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://www.thriftverse.shop/images/logo-circle.png",
        width: 1200,
        height: 630,
  ...
  return (
    <html lang="en">
      <Head>
        ...
        <meta property="og:image" content="https://www.thriftverse.shop/images/logo-circle.png" />
        ...
        <meta name="twitter:image" content="https://www.thriftverse.shop/images/logo-circle.png" />
      </Head>
      <body

...
export const metadata: Metadata = {
  title: 'Smart Search - AI-Powered Product Discovery | Thriftverse',
  description: 'Find exactly what you\'re looking for using natural language. Our AI understands your needs and finds the perfect products.',
};
